import { Grid, Title, Text, Image, Center, Button, Box } from '@mantine/core';
        ...
        <Box mt={'10rem'}>
            ...
            >
                <Grid.Col span={width > 1024 ? 6 : 12}>
                    ...
                    <Text pt={'1.25rem'}>
                        We help your vision become reality.
                    </Text>
                    <Text pt={'1.25rem'}>
                        Our innovative software and project management solutions
                        have powered important and impressive projects across an
                        array of industries. Take a look at what we have built
                        with our incredible partners, ranging from commercial,
