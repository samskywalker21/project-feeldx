import { Grid, Title, Text, Button, Image, Center, Box } from '@mantine/core';
            ...
            >
                <Grid.Col span={width > 1024 ? 6 : 12}>
                    ...
                    <Text pt={'1.25rem'}>
                        ...
                        audience perceives your project by integrating
                        cutting-edge visualisation and interactive technologies.
                    </Text>
                    <Text pt={'1.25rem'} hidden={width > 1024 ? false : true}>
                        Our approach blends strategy, storytelling, creative
                        technology, and experimentation. This dynamic
                        combination is evident in our work, which spans various
                        clients, sectors, and project phases. We pride ourselves
                        on adapting these elements seamlessly to create engaging
